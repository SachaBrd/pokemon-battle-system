...
// custom pokemons
pokemon.push(new Pokemon('SACHA', 50, 180, [moves['fire blast'], moves['psychic']], './assets/img/sacha.png', './assets/img/sacha.png'));
pokemon.push(new Pokemon('KHAZIX', 75, 150, [moves['fire blast'], moves['slash']], './assets/img/khazix.png', './assets/img/khazix2.webp'));
